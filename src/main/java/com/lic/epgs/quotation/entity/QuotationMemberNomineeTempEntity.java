...
@Setter
@Entity
@Table(name = "QUO_MBR_NOMI_TEMP")
public class QuotationMemberNomineeTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QUO_MBR_NOMI_TEMP_SEQ")
	@SequenceGenerator(name = "QUO_MBR_NOMI_TEMP_SEQ", sequenceName = "QUO_MBR_NOMI_TEMP_SEQ", allocationSize = 1)
