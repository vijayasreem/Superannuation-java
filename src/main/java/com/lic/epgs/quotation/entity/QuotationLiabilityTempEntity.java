...
@Setter
@Entity
@Table(name = "QUO_LIABILITY_DETAIL_TEMP")
public class QuotationLiabilityTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QUOTATION_LIABILITY_TEMP_SEQ")
	@SequenceGenerator(name = "QUOTATION_LIABILITY_TEMP_SEQ", sequenceName = "QUOTATION_LIABILITY_TEMP_SEQ", allocationSize = 1)
