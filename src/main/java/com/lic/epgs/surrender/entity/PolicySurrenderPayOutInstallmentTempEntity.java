...
@Setter
@Entity
@Table(name = "SUR_PAYOUT_INSTALLMENTS_TMP")
public class PolicySurrenderPayOutInstallmentTempEntity implements Serializable {
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PAYOUT_INSTALLMENTS_TEMP_SEQ")
	@SequenceGenerator(name = "PAYOUT_INSTALLMENTS_TEMP_SEQ", sequenceName = "PAYOUT_INSTALLMENTS_TEMP_SEQ", allocationSize = 1)
