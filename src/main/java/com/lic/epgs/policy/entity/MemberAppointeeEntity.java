...
@Setter
@Entity
@Table(name = "MEMBER_APPOINTEE")
public class MemberAppointeeEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "P_MBR_APP_M_SEQUENCE")
	@SequenceGenerator(name = "P_MBR_APP_M_SEQUENCE", sequenceName = "P_MBR_APP_M_SEQ", allocationSize = 1)
