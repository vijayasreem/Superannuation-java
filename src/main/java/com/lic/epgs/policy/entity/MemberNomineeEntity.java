...
@Setter
@Entity
@Table(name = "MEMBER_NOMINEE")
public class MemberNomineeEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "P_MBR_N_M_SEQUENCE")
	@SequenceGenerator(name = "P_MBR_N_M_SEQUENCE", sequenceName = "P_MBR_N_M_SEQ", allocationSize = 1)
