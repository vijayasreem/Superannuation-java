...
@Setter
@Entity
@Table(name = "POLICY_CONTRI_SUMMARY")
public class PolicyContributionSummaryEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_CON_S_M_SEQUENCE")
	@SequenceGenerator(name = "POL_CON_S_M_SEQUENCE", sequenceName = "POL_CON_S_M_SEQ", allocationSize = 1)
