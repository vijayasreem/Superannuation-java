...
@Setter
@Entity
@Table(name = "MEMBER_TRANS_ENTRIES_TEMP")
public class MemberTransactionEntriesTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "P_MBR_T_E_T_SEQUENCE")
	@SequenceGenerator(name = "P_MBR_T_E_T_SEQUENCE", sequenceName = "P_MBR_T_E_T_SEQ", allocationSize = 1)
