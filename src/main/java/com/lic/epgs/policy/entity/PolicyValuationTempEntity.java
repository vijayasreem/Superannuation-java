...
@Setter
@Entity
@Table(name = "POLICY_VALUATION_TEMP")
public class PolicyValuationTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_V_T_SEQUENCE")
	@SequenceGenerator(name = "POL_V_T_SEQUENCE", sequenceName = "POL_V_T_SEQ", allocationSize = 1)
