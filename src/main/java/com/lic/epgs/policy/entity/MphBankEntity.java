...
@Entity
@Table(name = "MPH_BANK")
public class MphBankEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "MPH_BNK_M_SEQUENCE")
	@SequenceGenerator(name = "MPH_BNK_M_SEQUENCE", sequenceName = "MPH_BNK_M_SEQ", allocationSize = 1)
