...
@Setter
@Entity
@Table(name = "POLICY_DEPOSIT_TEMP")
public class PolicyDepositTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_DEPO_T_SEQUENCE")
	@SequenceGenerator(name = "POL_DEPO_T_SEQUENCE", sequenceName = "POL_DEPO_T_SEQ", allocationSize = 1)
