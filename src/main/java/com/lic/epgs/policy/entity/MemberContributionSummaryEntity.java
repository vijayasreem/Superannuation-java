...
@Setter
@Entity
@Table(name = "MEMBER_CONTRI_SUMMARY")
public class MemberContributionSummaryEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "P_MBR_CO_S_M_SEQUENCE")
	@SequenceGenerator(name = "P_MBR_CO_S_M_SEQUENCE", sequenceName = "P_MBR_CO_S_M_SEQ", allocationSize = 1)
