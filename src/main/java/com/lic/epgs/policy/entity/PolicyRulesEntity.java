...
public class PolicyRulesEntity implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_RUL_M_SEQUENCE")
	@SequenceGenerator(name = "POL_RUL_M_SEQUENCE", sequenceName = "POL_RUL_M_SEQ", allocationSize = 1)
	@Column(name = "RULE_ID")
	private Long ruleId;
