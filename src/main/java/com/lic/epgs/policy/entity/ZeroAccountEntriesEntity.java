...
@Setter
@Entity
@Table(name = "ZERO_ACC_ENTRIES")
public class ZeroAccountEntriesEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "Z_ACC_E_M_SEQUENCE")
	@SequenceGenerator(name = "Z_ACC_E_M_SEQUENCE", sequenceName = "Z_ACC_E_M_SEQ", allocationSize = 1)
