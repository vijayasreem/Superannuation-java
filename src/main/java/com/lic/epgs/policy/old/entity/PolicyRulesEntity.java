...
//@Entity
//@Table(name = "POL_RULE")
public class PolicyRulesEntity implements Serializable {

	private static final long serialVersionUID = 1L;

//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_RULE_M_SEQUENCE")
//	@SequenceGenerator(name = "POL_RULE_M_SEQUENCE", sequenceName = "POL_RULE_M_SEQ", allocationSize = 1)
	@Column(name = "RULE_ID")
	private Long ruleId;
