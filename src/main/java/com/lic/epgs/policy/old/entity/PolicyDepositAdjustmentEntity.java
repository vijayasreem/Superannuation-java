...
@Setter
//@Entity
//@Table(name = "POL_DEPOSIT_ADJ")
public class PolicyDepositAdjustmentEntity implements Serializable {

	private static final long serialVersionUID = 1L;
//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_ADJ_M_SEQUENCE")
//	@SequenceGenerator(name = "POL_ADJ_M_SEQUENCE", sequenceName = "POL_ADJ_M_SEQ", allocationSize = 1)
