...
//@Entity
//@Table(name = "POL_BNK")
public class PolicyBankEntity implements Serializable {

	private static final long serialVersionUID = 1L;

//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_BNK_M_SEQUENCE")
//	@SequenceGenerator(name = "POL_BNK_M_SEQUENCE", sequenceName = "POL_BNK_M_SEQ", allocationSize = 1)
