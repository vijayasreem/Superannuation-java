...
@Setter
//@Entity
//@Table(name = "POL_DEPOSIT_ADJ_TEMP")
public class PolicyDepositAdjustmentTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;
//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_ADJ_SEQUENCE")
//	@SequenceGenerator(name = "POL_ADJ_SEQUENCE", sequenceName = "POL_ADJ_SEQ", allocationSize = 1)
	@Column(name = "ADJESTMENT_ID")
	private Long adjestmentId;
