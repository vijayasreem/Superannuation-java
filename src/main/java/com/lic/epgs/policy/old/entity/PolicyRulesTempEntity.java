...
@Setter
//@Entity
//@Table(name = "POL_RULE_TEMP")
public class PolicyRulesTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;

//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_RULE_SEQUENCE")
//	@SequenceGenerator(name = "POL_RULE_SEQUENCE", sequenceName = "POL_RULE_SEQ", allocationSize = 1)
	@Column(name = "RULE_ID")
	private Long ruleId;
