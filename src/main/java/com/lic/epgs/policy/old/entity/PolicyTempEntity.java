...
public class PolicyTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;

//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POLICYID_SEQUENCE")
//	@SequenceGenerator(name = "POLICYID_SEQUENCE", sequenceName = "POLICYID_SEQ", allocationSize = 1)
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	@JoinColumn(name = "POLICY_ID", referencedColumnName = "POLICY_ID")
	private Set<PolicyAddressTempEntity> addresses = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	@JoinColumn(name = "POLICY_ID", referencedColumnName = "POLICY_ID")
	private Set<PolicyBankTempEntity> bankDetails = new HashSet<>();

//	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
//	@JoinColumn(name = "POLICY_ID", referencedColumnName = "POLICY_ID")
//	private Set<PolicyDocsTempEntity> docs = new HashSet<>();
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	@JoinColumn(name = "POLICY_ID", referencedColumnName = "POLICY_ID")
	private Set<PolicyDepositTempEntity> deposit = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	@JoinColumn(name = "POLICY_ID", referencedColumnName = "POLICY_ID")
	private Set<PolicyDepositAdjustmentTempEntity> adjustments = new HashSet<>();
	
//	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
//	@JoinColumn(name = "SOURCE_POLICY_ID", referencedColumnName = "POLICY_ID")
//	private Set<MemberLevelTransferOutTempEntity> sourcePolicyId = new HashSet<>();
//	
//	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
//	@JoinColumn(name = "DEST_POLICY_ID", referencedColumnName = "POLICY_ID")
//	private Set<MemberLevelTransferOutTempEntity> destPolicyID = new HashSet<>();
