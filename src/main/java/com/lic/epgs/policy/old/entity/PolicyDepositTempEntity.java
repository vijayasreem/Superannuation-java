...
@Setter
//@Entity
//@Table(name = "POL_DEPOSIT_TEMP")
public class PolicyDepositTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;
//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_DEPO_SEQUENCE")
//	@SequenceGenerator(name = "POL_DEPO_SEQUENCE", sequenceName = "POL_DEPO_SEQ", allocationSize = 1)
