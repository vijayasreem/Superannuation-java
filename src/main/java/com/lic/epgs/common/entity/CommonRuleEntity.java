...
public class CommonRuleEntity implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QUOTATION_RULE_SEQ")
	@SequenceGenerator(name = "QUOTATION_RULE_SEQ", sequenceName = "QUOTATION_RULE_SEQ", allocationSize = 1)
