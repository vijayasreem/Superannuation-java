...
@Setter
@Entity
@Table(name = "COMMON_DOCS")
public class CommonDocsEntity implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "COMMONID_DOCS_SEQUENCE")
	@SequenceGenerator(name = "COMMONID_DOCS_SEQUENCE", sequenceName = "COMMONID_DOCS_SEQ", allocationSize = 1)
