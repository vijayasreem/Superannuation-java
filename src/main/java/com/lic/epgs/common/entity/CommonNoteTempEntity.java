...
@Setter
@Entity
@Table(name = "NOTE_DETAILS_TEMP")
public class CommonNoteTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "NOTEID_SEQUENCE")
	@SequenceGenerator(name = "NOTEID_SEQUENCE", sequenceName = "NOTEID_SEQ", allocationSize = 1)
